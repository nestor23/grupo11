<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
    ...
    String mensaje ="";
    boolean exito = nuevoTipoVta.crearTipoVenta(idTipoVta, descripcion, fechaIng);    
    
    if(exito){
    	mensaje = "El nuevo tipo de venta ha sido registrado";
    }else{
...
<title>Registro de tipo de ventas</title>
</head>
<body>
<%= mensaje %>
</body>
