<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    String mensaje ="";
    boolean exito = nuevoCliente.guardarCliente(idCliente, nombCliente, apCliente, domCliente, telCliente, e_mail, tipocliente);
    System.out.println(nuevoCliente.toString());
    
    
    if(exito){
    	mensaje = "El nuevo Cliente ha sido registrado";
    }else{
